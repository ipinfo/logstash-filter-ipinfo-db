...
=== logstash-filter-ipinfo filter plugin
...
The field containing the IP address or hostname to map via ipinfo plugin. The field to lookup in ipinfo database.
